...
void main() {
  ...
  test('ERC20 encode transfer', () {
    var callParams = [
      CallParam('_to', 'c9d983203307abccd3e1b303a00ea0a19724fe2c'),
      CallParam('_value', BigInt.from(13412000000))
    ];

    var call = ContractCall('transfer', callParams);
    expect(
  ...
  test('ERC20 encode approve', () {
    var callParams = [
      CallParam('_spender', '7a250d5630b4cf539739df2c5dacb4c659f2488d'),
      CallParam('_value', BigInt.parse('115792089237316195423570985008687907853269984665640564039457584007913129639935'))
    ];

    var call = ContractCall('approve', callParams);
    expect(
      hex.encode(call.toBinary(abi)),
